...
const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Aceitamos PIX (com 5% de desconto), cartão de crédito (parcelamento em até 12x), boleto bancário e Mercado Pago. Para pedidos corporativos, consulte condições especiais."
    },
    {
      question: "Qual é a quantidade mínima de pedido?",
      answer: "A quantidade mínima varia por produto. Geralmente é de 30 unidades para sabonetes artesanais e 10 unidades para velas. Consulte cada produto ou fale conosco para pedidos menores."
    },
    {
      question: "Como funciona o processo de encomenda?",
      answer: "É simples: 1) Entre em contato via WhatsApp, 2) Defina o modelo e personalizações, 3) Receba o orçamento, 4) Confirme o pedido com pagamento, 5) Aguarde a produção e receba em casa!"
    }
  ];
