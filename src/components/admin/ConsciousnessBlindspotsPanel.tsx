...
export default function ConsciousnessBlindspotsPanel({ blindspots, warnings }: Props) {
  return (
    <Card>
      <CardHeader><CardTitle className="text-base">Consciousness Blindspots</CardTitle></CardHeader>
